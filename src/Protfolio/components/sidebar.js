    ...
    return (
        ...
        >
            ...
            <figure className='social_icons'>
                <a href="/"><img src={facebook} alt="facebook" className='icon_small social_icon' /></a>
                <a href="/"><img src={instagram} alt="instagram" className='icon_small social_icon' /></a>
            </figure>
            <div className="contact">
                <div className="location side_item"><img src={pin} alt="pin" className='icon_small  mr-1' />  Kolkata</div>
                <a href="/"><div className="github side_item"> <img src={github} alt="git" className='icon_small social_icon mr-1' />  github </div></a>
